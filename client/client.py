...
def send_vote(vote_id: int, vote: tuple[str, str] | None, address: str, user_key, backend_key,
    ...
    vote_encrypted = gpg.encrypt(json.dumps(vote_json), recipients=backend_key["fingerprint"]).data.decode("utf-8")
...
if __name__ == '__main__':
    ...
    send_vote(voter_id, user_vote, intermediary_address, key, backend_key=backend_key, encryptor=gpg)  # temporary
